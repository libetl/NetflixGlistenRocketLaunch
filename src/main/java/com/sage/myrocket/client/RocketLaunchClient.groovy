...
class RocketLaunchClient {
	...
	static void main (String[] args){
		...
		RocketLaunchWorkflowDescriptionTemplate workflowDescriptionTemplate = new RocketLaunchWorkflowDescriptionTemplate ()
		// now you just need one of these for describing your workflow
		
		// Now you can get your client
		InterfaceBasedWorkflowClient<RocketLaunchWorkflow> client = workflowClientFactory.getNewWorkflowClient(RocketLaunchWorkflow, workflowDescriptionTemplate)
